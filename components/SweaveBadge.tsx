...
function SweaveBadge() {
  ...
  return (
    <Link href="https://x.com/swveio" target="_blank" rel="noopener noreferrer">
      <div
        className={`fixed z-50 bottom-4 left-4 flex space-x-1 items-center bg-white/80 backdrop-blur-md rounded-full px-2 pr-2.5 py-1 nice-shadow hover:light-shadow-lg transition-all duration-400 ${
