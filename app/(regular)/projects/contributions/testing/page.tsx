...
export const metadata: Metadata = {
  title: 'Open Source Projects with testing issues to contribute to | Contribhub',
  description: 'Find the best open source projects with testing issues to contribute to'
}
