...
export const metadata: Metadata = {
  title: 'Open Source Projects looking for optimizing their codebase | Contribhub',
  description: 'Find the best open source projects looking for optimizing their code'
}
