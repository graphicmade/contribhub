...
export const metadata: Metadata = {
  title: 'Open Source Projects with design and UI issues to contribute to | Contribhub',
  description: 'Find the best open source projects with design issues to contribute to'
}
